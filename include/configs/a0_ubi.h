 ...
 * Console
 */
#define CONFIG_CONSOLE_BAUDRATE      2000000
...
#else
#define CONFIG_KERNEL_ARGS KERNEL_ARGS_COMMON KERNEL_ARGS_INIT "ubi.mtd=2 root=ubi0:rootfs rootfstype=ubifs"
//#define CONFIG_KERNEL_ARGS KERNEL_ARGS_COMMON KERNEL_ARGS_INIT "root=/dev/mtdblock2"
#endif /* CONFIG_RECOVERY */
